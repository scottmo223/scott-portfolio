export default function Footer() {
    return (
        <footer className=" w-full bg-gray-900 text-white shadow-lg z-50 row-start-3 flex gap-[24px] flex-wrap items-center justify-center">
            <div className="container py-5 flex justify-evenly items-baseline">
                <h5>Scott Morales &copy; {new Date().getFullYear()}</h5>
                <div className="flex items-center gap-4">
                    <a
                        ...
                        aria-label="LinkedIn"
                        className="hover:text-teal-400 transition p-1"
                    >
                        <svg
                            viewBox="0 0 24 24"
                            className="h-5 w-5"
